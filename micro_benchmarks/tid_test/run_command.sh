...
# run Rama on optbc
#opt -load /scratch/neelakandan/tools/llvm-3.8-build/lib/LLVMPointerAnalysis.so -rama < simple_tester.optbc_inline > simple_tester.optbc2
#llvm-dis simple_tester.optbc2
