...
rm -rf analysis.txt
# run Rama on optbc
opt -load /scratch/neelakandan/tools/llvm-3.8-build/lib/LLVMPointerAnalysis.so -rama < simple_matrix.optbc_inline 2> analysis.txt
